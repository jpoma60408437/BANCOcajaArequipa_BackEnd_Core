"""Router de operaciones Caja Arequipa (pago de cuota, transferencia, pago de servicios). Exigen get_cliente."""
...
def servicios(cliente: dict = Depends(get_cliente)):
    """Catálogo de servicios afiliados Caja Arequipa disponibles para pagar."""
