"""Controlador de autenticación: reglas de login y emisión de JWT — Caja Arequipa."""
...
def login(conn: Connection, username: str, password: str) -> dict:
    ...
    if usuario["bloqueado"] == "S":
        raise HTTPException(
            ...
            detail="Usuario bloqueado por intentos fallidos. Comuníquese con Caja Arequipa "
                   "al (54) 380670 o escriba a servicioalcliente@cajaarequipa.pe",
        )
    ...
    if not verificar_password(password, usuario["password_hash"]):
        ...
        if restantes == 0:
            detalle = (
                "Credenciales inválidas. Usuario bloqueado por exceder intentos. "
                "Contáctenos al (54) 380670 o servicioalcliente@cajaarequipa.pe"
            )
        else:
