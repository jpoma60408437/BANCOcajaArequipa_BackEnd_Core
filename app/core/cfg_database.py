"""Engine de SQLAlchemy (SQL crudo con text()) y dependencia get_db — Caja Arequipa.

No se usa ORM declarativo: solo engine + Connection + text().
La BD bd_core_financiero YA EXISTE y es compartida con el core bancario; no se crean tablas.
"""
